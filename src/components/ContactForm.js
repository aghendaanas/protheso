...
const ContactForm = () => {
    ...
    return (
        <div className="contact-form-container">
            <h2>Formulaire de Contact / استمارة الاتصال</h2>
            <form className="contact-form" onSubmit={handleSubmit}>
                ...
                <select name="gender" value={formData.gender} onChange={handleInputChange} required>
                    <option value="">Sélectionnez le genre / اختر الجنس</option>
                ...
                <label>Comment nous avez-vous connu ? / كيف سمعت عنا؟</label>
                <select name="howDidYouHear" value={formData.howDidYouHear} onChange={handleInputChange} required>
                    <option value="">Sélectionnez une option / اختر خياراً</option>
                    <option value="Internet">Internet / الإنترنت</option>
                    <option value="Friend">Ami / صديق</option>
                    <option value="Advertisement">Publicité / إعلان</option>
                ...
                <label>
                    Téléchargez une photo de votre bouche ou de vos dents : / حمل صورة لفمك أو أسنانك:
                    <input type="file" name="mouthPicture" onChange={handleFileChange} accept="image/*" />
                </label>

                <button type="submit">Soumettre / إرسال</button>
            </form>
